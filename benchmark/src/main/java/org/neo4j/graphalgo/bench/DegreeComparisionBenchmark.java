...
public class DegreeComparisionBenchmark {
    ...
    public static void setup() throws KernelException {
        ...
        procedures.registerProcedure(DegreeCentralityProc.class);
    ...
    public Object _01_benchmark_sequential() {
        return db.execute("CALL algo.degree('','', {write:false}) YIELD computeMillis")
                .stream()
                .count();
    }
    ...
    public Object _04_benchmark_parallel8() {
        return db.execute("CALL algo.degree('','', {write:false, concurrency:8}) YIELD computeMillis")
                .stream()
                .count();
    }
}
