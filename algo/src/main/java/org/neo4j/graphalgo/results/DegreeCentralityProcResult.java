 ...
 * @author mknblch
 */
public class DegreeCentralityProcResult {
    ...
    private DegreeCentralityProcResult(Long loadMillis,
                                       Long computeMillis,
                                       Long writeMillis,
                                       Long nodes,
    ...
    public static class Builder extends AbstractResultBuilder<DegreeCentralityProcResult> {
        ...
        public DegreeCentralityProcResult build() {
            return new DegreeCentralityProcResult(loadDuration,
                    evalDuration,
                    writeDuration,
                    nodes,
                    centralityMin,
