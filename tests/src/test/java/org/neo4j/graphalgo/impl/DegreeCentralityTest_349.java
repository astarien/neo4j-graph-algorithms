...
public class DegreeCentralityTest_349 {
    ...
    public void test() throws Exception {
        ...
        final String importCypher = "CALL algo.degree('User', 'FRIEND', " +
    ...
    public void testDirect() throws Exception {
        ...
        final double[] centrality = new DegreeCentrality(graph)
                .compute()
                .getCentrality();
...
//            System.out.printf("%4d : %9.2f%n", i, centrality[i]);
    ...
    public void testDirectParallel() throws Exception {
        ...
        final Optional<DegreeCentrality.Result> any = new ParallelDegreeCentrality(graph, Pools.DEFAULT, 4)
