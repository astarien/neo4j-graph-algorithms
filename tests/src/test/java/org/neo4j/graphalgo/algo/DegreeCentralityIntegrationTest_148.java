...
public class DegreeCentralityIntegrationTest_148 {
    ...
    @Test
    public void testDCStreamDirectionBoth() throws Exception {

        final Consumer mock = mock(Consumer.class);
        final String evalQuery = "CALL algo.degree.stream('User', 'FRIEND', {direction:'B'}) YIELD nodeId, centrality";
