...
public class DegreeCentralityIntegrationTest_282 {
    ...
    /**
     * test org.neo4j.graphalgo.impl.DegreeCentrality
     *
     * @throws Exception
     */
    @Test
    public void testDCWriteBack() throws Exception {

        final String evalQuery = "CALL algo.degree('Node', 'EDGE', {write:true, stats:true, writeProperty:'centrality'})\n" +
     ...
     */
    @Test
    public void testDCWriteBackParallel() throws Exception {

        final String evalQuery = "CALL algo.degree('Node', 'EDGE', {write:true, stats:true, writeProperty:'centrality', concurrency:4})\n" +
                "YIELD nodes, minCentrality, maxCentrality, sumCentrality";
